...
if __name__ == '__main__':
    ...
    for c in config:
        if c == 1:
            # models = ['deepseek_bin_allonce', 'deepseek_bin_nodistinction', 'deepseek_bin_notags', 'deepseek_bin_nodescription', 'deepseek_bin_nointro', 'deepseek_bin', 'chatgpt_bin_3.5', 'chatgpt_bin_allonce', 'chatgpt_bin_nodistinction', 'chatgpt_bin_notags', 'chatgpt_bin_nodescription', 'chatgpt_bin_nointro', 'chatgpt_bin']
