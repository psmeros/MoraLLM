...
def compute_moral_foundations(dictionary_file, output_file):
...
if __name__ == '__main__':
    ...
    compute_moral_foundations(dictionary_file='data/misc/eMFD.pkl', output_file='data/cache/moral_foundations.pkl')
